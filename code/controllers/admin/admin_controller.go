...
func AdminController(httpResponseWriter http.ResponseWriter, request *http.Request) {
	...
	case config.LOCAL:
		adminPageObject.AppEnvironment = "Local"
	case config.TEST:
		adminPageObject.AppEnvironment = "Test"
	case config.STAGING:
		adminPageObject.AppEnvironment = "Staging"
	case config.PRODUCTION:
		adminPageObject.AppEnvironment = "Production"
	default:
		adminPageObject.AppEnvironment = "Unknown"
	}
	...
	case kAdminRouteName_Home:
		showAdminPage(httpResponseWriter, request, adminPageObject)
	case kAdminRouteName_Metadata:
		showAdminMetadataPage(httpResponseWriter, request, adminPageObject)
